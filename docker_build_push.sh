...
docker tag ${IMAGE_NAME}_${HOST_ARCH}:${VERSION} ${HUB_PATH}/${HOST_ARCH}:${VERSION}
docker push ${HUB_PATH}/${HOST_ARCH}:${VERSION}

docker tag ${IMAGE_NAME}_${HOST_ARCH}:${VERSION} ${HUB_PATH}/${HOST_ARCH}:latest
docker push ${HUB_PATH}/${HOST_ARCH}:latest
