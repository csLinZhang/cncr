...
#else
#define PRINT_MSG(m) printf( "Stage: \n" )
#define PRINT_MSG1(m,a) printf( "Stage: \n", a)
#define PRINT_MSG2(m,a,b) printf( "Stage: \n,", a, b )
#define PRINT_MSG3(m,a,b,c) printf( "Stage: \n", a, b, c )
#define PRINT_MSG4(m,a,b,c,d) printf( "Stage: \n", a, b, c, d )
#define PRINT_MSG5(m,a,b,c,d,e) printf( "Stage: \n", a, b, c, d, e )
#endif
...
#define PRINT_DEBUG5(m,a,b,c,d,e)
  ...
  */
  ...
  public:
    ...
    //
    void LoadBitmap(const std::string& map_file_path);
