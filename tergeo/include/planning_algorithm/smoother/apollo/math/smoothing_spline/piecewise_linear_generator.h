...
#include "smoothing_spline/piecewise_linear_constraint.h"
#include "smoothing_spline/piecewise_linear_kernel.h"
...
class PiecewiseLinearGenerator {
 ...
 private:
  ...
  std::unique_ptr<tergeo::common::math::QpSolver> qp_solver_;
};
