...
#include "smoothing_spline/affine_constraint.h"
#include "smoothing_spline/spline_2d.h"
...
class Spline2dConstraint {
 public:
  ...
  bool Add2dBoundary(const std::vector<double>& t_coord,
                     ...
                     const std::vector<tergeo::common::math::Vec2d>& ref_point,
 ...
 private:
  ...
  double SignDistance(const tergeo::common::math::Vec2d& xy_point,
